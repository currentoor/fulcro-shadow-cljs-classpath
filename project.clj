(defproject fulcro-shadow-cljs-classpath "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "fulcro_shadow_cljs_classpath.jar"
  ...
  :profiles {:uberjar    {:main fulcro-shadow-cljs-classpath.server-main
                                :aot :all
